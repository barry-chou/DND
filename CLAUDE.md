...
### NPC 系統
- **命名即重要** - 所有有名有姓的 NPC 都記入存檔資料夾的 `npcs.md`
...
4. **NPC 記憶** - 所有有名有姓的 NPC 必須記入存檔資料夾的 npcs.md,保持一致性
...
### 存檔資料夾 (saves/)
讀檔後請參考對應存檔資料夾中的:
- `character.md` - 角色卡 (基本資料、屬性、戰鬥數據、技能)
- `npcs.md` - NPC 記錄 (關係、好感度、重要互動)
- `journal.md` - 冒險日誌 (詳細的每日記錄)
- `quests.md` - 任務進度與待辦事項
- `notes.md` - GM 備註與未解之謎
- `data/` - 遊戲數據 JSON 檔案

存檔資料夾的標準結構請參考 `dnd.md` 遊戲數據管理系統章節
