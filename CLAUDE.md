...
### 遇到具體規則問題時:
- 💥 **戰鬥** → 讀取 `dnd.md` 第五章「戰鬥系統」
- 🎯 **技能判定** → 讀取 `dnd.md` 第三、四章「技能與判定系統」
- 🧙 **法術** → 讀取 `dnd.md` 第六章「法術系統」
- 📈 **升級** → 讀取 `dnd.md` 第七章「經驗與升級」
- 👤 **NPC** → 讀取 `dnd.md` 第十一、十五章「NPC 系統與範本」
- 🛡️ **裝備/價格** → 讀取 `dnd.md` 第九章「裝備與經濟」
...
**基礎規則:**
- **核心原則:** dnd.md 第 7-16 行
- **GM 操作指令:** dnd.md 第 19-230 行
- **角色創建系統:** dnd.md 第 233-372 行
- **屬性系統:** dnd.md 第 374-428 行
- **技能系統:** dnd.md 第 430-456 行

**判定與戰鬥:**
- **判定系統:** dnd.md 第 458-516 行
- **判定執行方式:** dnd.md 第 545-686 行 (訓練總評擲骰法、Fail Forward)
- **戰鬥系統:** dnd.md 第 698-796 行
- **戰鬥流程實例:** dnd.md 第 1217-1252 行

**進階系統:**
- **法術系統:** dnd.md 第 766-793 行
- **經驗與升級:** dnd.md 第 797-853 行
- **專長系統:** dnd.md 第 945-957 行
- **裝備與經濟:** dnd.md 第 1470-1533 行

**敘事與 NPC:**
- **世界觀設定:** dnd.md 第 1024-1085 行
- **NPC 系統:** dnd.md 第 1087-1117 行
- **敘事原則:** dnd.md 第 1119-1177 行
- **NPC 記憶卡範本:** dnd.md 第 1255-1288 行

**數據管理:**
- **遊戲數據管理系統:** dnd.md 第 233 行起 (在 GM 操作指令之後)
- **存檔檔案結構範本:** dnd.md 第 1290 行起
...
### NPC
- 所有有名有姓的 NPC 記入 `npcs.md`
- 立體塑造,持續發展
- 詳細規則見 `dnd.md` 第十一、十五章

### 數據
- 先查 JSON,再回應
- 第一次生成,永久固定
- 詳細規則見 `dnd.md` 遊戲數據管理系統章節
