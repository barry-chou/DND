...
7. ✅ **Markdown 格式化** - 使用引用區塊、粗體、分隔線增強視覺體驗
...
### 核心原則
- **保留完整系統** - 顯示所有擲骰、數值、檢定過程
- **Markdown 格式化** - 使用格式化元素增強視覺體驗與層次感
- **沉浸式敘事** - 系統數據與劇情敘事自然融合
...
| 元素 | 用途 | 範例 |
|------|------|------|
| `> **角色名**` | 角色對話 | `> **阿布拉漢**`<br>`> "願光明指引你!"` |
| `**【】**` | 重要系統提示 | `**【HP: 3/18 危險!】**` |
| `【】` | 一般檢定/數值 | `【攻擊檢定】d20 = 16 + 8 = 24` |
| `---` | 場景分隔 | 用於轉換場景或戰鬥回合 |
| `###` | 章節標題 | `### 地下淨化之戰` |
| `**粗體**` | 強調關鍵字 | `**瀕死!**` `**升級!**` |
| `(括號)` | 動作或內心 | `(咬牙)` `(內心)` |
